        ...
        <footer className="bg-[#005380] text-white px-[10%] mx-auto">
            <div className="flex justify-between flex-wrap mx-auto">
                <div className="w-full">
                    <h2 className="logo text-xl text-center my-5 font-bold GillFont">Mahima Chaudhary</h2>
            ...
            >
                ...
                <span onClick={() => setShowTerms(true)} className="mb-1 font-serif">Terms of Use</span>
